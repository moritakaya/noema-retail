...
generateTestCase (CounterExample ce) =
  ...
  , "import Noema.Cognition.InventoryInterpretation (interpretInventoryF)"
  , ""
  , "spec :: Spec Unit"
  ...
  , ""
  , "    result <- realizeIntent interpretInventoryF intent unit"
  , ""
...
generateSuggestedFixes (Violation v) = case v.property of
  "NonNegativeStock" -> String.joinWith "\n"
    [ ""
    , "  Option 1: Add guard in Interpretation"
    , "  ─────────────────────────────────"
    , "  interpretAdjust pid delta = do"
...
generateGitHubIssue (CounterExample ce) =
  ...
  , "- `src/Noema/Cognition/InventoryInterpretation.purs`"
