---- MODULE InventorySimple_TTrace_1767725466 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("InventorySimple_TTrace_1767725466.json", _TETrace)
...
\*
\*trace == IODeserialize("InventorySimple_TTrace_1767725466.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([reserved |-> (<<p1, l1>> :> 0),pendingSync |-> (p1 :> {ch1}),stock |-> (<<p1, l1>> :> 1)]),
    ([reserved |-> (<<p1, l1>> :> 1),pendingSync |-> (p1 :> {ch1}),stock |-> (<<p1, l1>> :> 0)]),
    ([reserved |-> (<<p1, l1>> :> 1),pendingSync |-> (p1 :> {ch1}),stock |-> (<<p1, l1>> :> 3)]),
    ([reserved |-> (<<p1, l1>> :> 0),pendingSync |-> (p1 :> {ch1}),stock |-> (<<p1, l1>> :> 4)])
    >>
----
...
---- CONFIG InventorySimple_TTrace_1767725466 ----
CONSTANTS
    ProductIds = { p1 }
    LocationIds = { l1 }
    MaxQuantity = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Wed Jan 07 03:51:07 JST 2026